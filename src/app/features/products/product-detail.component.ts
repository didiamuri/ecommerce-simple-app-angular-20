            ...
            <div class="pt-6">
                <nav aria-label="Breadcrumb">
                    <ol role="list"
                        ...
                        <li class="text-sm">
                            <a [routerLink]="['/products', p.id]" aria-current="page"
                               class="font-medium text-gray-500 hover:text-gray-600">{{ p.title }}</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
                    ...
                    <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                        <div class="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                            <img [src]="p.images[1] || p.images[0]" [alt]="p.title"
                                 class="w-full h-full object-center object-cover">
                        </div>
                        <div class="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                            <img [src]="p.images[2] || p.images[0]" [alt]="p.title"
                                 class="w-full h-full object-center object-cover">
                        </div>
                    </div>
                    ...
                    <div class="mt-4 lg:mt-0 lg:row-span-3">
                        ...
                        <div *ngIf="authService.isAdmin()" class="mt-4">
                            <a [routerLink]="['/admin/products', p.id]"
                               class="w-full bg-gray-200 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-gray-900 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                Edit Product (Admin)
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="mt-10">
                            ...
                            <div class="mt-4">
                                <ul role="list" class="pl-4 list-disc text-sm space-y-2">
                                    <li class="text-gray-400"><span class="text-gray-600">Brand: {{ p.brand }}</span>
                                    </li>
                                    <li class="text-gray-400"><span
                                        class="text-gray-600">Category: {{ p.category }}</span></li>
                                    <li class="text-gray-400"><span class="text-gray-600">Rating: {{ p.rating }}
                                        /5</span></li>
                                </ul>
                            </div>
                        </div>
